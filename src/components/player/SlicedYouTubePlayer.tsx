...
const POLL_INTERVAL_MS = 500 // how often we check playback position
 ...
 */
export function SlicedYouTubePlayer({
  ytVideoId,
  startTimeSeconds,
  endTimeSeconds,
  onSectionEnd,
  ...
  }, [ready, startTimeSeconds, endTimeSeconds, sectionDuration, onSectionEnd])
