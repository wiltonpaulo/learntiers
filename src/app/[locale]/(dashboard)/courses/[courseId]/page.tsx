        ...
        <div className="flex flex-col lg:flex-row gap-10">
          <div className="flex-1 lg:w-2/3 min-w-0">
            ...
            <div className="flex items-center gap-2 text-sm text-muted-foreground mb-6">
              ...
              <span>•</span>
              <span>{totalDuration ? formatDuration(totalDuration) : '0s'} total length</span>
            </div>
                  ...
                  <div className="space-y-4 text-sm text-muted-foreground pt-2">
                    ...
                    <ul className="space-y-3.5">
                      <li className="flex items-center gap-3">
                        <MonitorPlay className="w-4 h-4 text-foreground/70" /> {totalDuration ? formatDuration(totalDuration) : '0s'}{' '}
                        on-demand video
                      </li>
                      <li className="flex items-center gap-3">
